...
export declare const zh: {
    ...
    'guidance.unavailable': string;
    'guidance.howto': string;
    'guidance.switch.intro': string;
    'guidance.switch.thinkingFormat': string;
    'guidance.switch.reasoningEffort': string;
    'guidance.switch.developerRole': string;
    'guidance.switch.replay': string;
    'agent.copy': string;
    'agent.intro': string;
