...
export const BUILTIN_ENTRIES = [
    {
        ...
        provider: '*',
        model: 'glm-5.2',
        note: 'GLM-5.2 native levels minimal / low / medium / high (Zhipu z.ai deep-thinking docs); the Aliyun Bailian OpenAI-compatible endpoint accepts these values in practice.',
        efforts: {
            minimal: 'minimal',
            low: 'low',
            medium: 'medium',
    ...
    },
    {
        ...
        provider: '*',
        model: 'kimi/kimi-k3',
        note: 'Kimi K3 official levels low / high / max (Moonshot thinking-effort docs), consistent with the pi-ai catalog moonshotai entry.',
        efforts: {
            low: 'low',
            high: 'high',
            max: 'max',
