...
`main` is currently versioned `0.4.0` and includes the Big Fat Fish slider. The latest tag is still `v0.3.0`; replace `#main` with `#v0.3.0` if you specifically want the tagged release.
