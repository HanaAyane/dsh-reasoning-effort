...
function removeStrayArtifacts(strip) {
  ...
  for (let f = 0; f < 8; f++) {
    ...
    // Keep ONLY the largest main component, zero out all smaller islands
...
const rawSrc = fs.readFileSync('C:/Users/15528/.dsh/attachments/v1/objects/77/77b3d10ee432f5a60e19878976a69dee5864f3e4ef828adfa4e2f3fcd1573376');
...
console.log('=== Validation of Generated Gemini Target Strip ===');
for (let f = 0; f < 8; f++) {
...
fs.writeFileSync('C:/Users/15528/.dsh/plugins/dsh-reasoning-effort/assets/gemini-runner-strip.png', encoded);
console.log('Successfully saved C:/Users/15528/.dsh/plugins/dsh-reasoning-effort/assets/gemini-runner-strip.png (' + encoded.length + ' bytes)');
